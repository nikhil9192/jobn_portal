...
-- --------------------------------------------------
-- Date Created: 12/27/2023 09:29:47
-- Generated from EDMX file: C:\Users\chand\Downloads\prasanthrll\ReRllProject-master\JobsPortal\DatabaseAccessLayer\JobPortalsDbModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_CompanyTable_UserTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompanyTable] DROP CONSTRAINT [FK_CompanyTable_UserTable];
GO
IF OBJECT_ID(N'[dbo].[FK_EmployeesTable_UserTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EmployeesTable] DROP CONSTRAINT [FK_EmployeesTable_UserTable];
GO
IF OBJECT_ID(N'[dbo].[FK_JobRequirementDetailsTable_JobRequirementsTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[JobRequirementDetailsTable] DROP CONSTRAINT [FK_JobRequirementDetailsTable_JobRequirementsTable];
GO
IF OBJECT_ID(N'[dbo].[FK_JobRequirementDetailsTable_PostJobTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[JobRequirementDetailsTable] DROP CONSTRAINT [FK_JobRequirementDetailsTable_PostJobTable];
GO
IF OBJECT_ID(N'[dbo].[FK_PostJobTable_CompanyTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PostJobTable] DROP CONSTRAINT [FK_PostJobTable_CompanyTable];
GO
IF OBJECT_ID(N'[dbo].[FK_PostJobTable_JobCategoryTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PostJobTable] DROP CONSTRAINT [FK_PostJobTable_JobCategoryTable];
GO
IF OBJECT_ID(N'[dbo].[FK_PostJobTable_JobNatureTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PostJobTable] DROP CONSTRAINT [FK_PostJobTable_JobNatureTable];
GO
IF OBJECT_ID(N'[dbo].[FK_PostJobTable_JobStatusTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PostJobTable] DROP CONSTRAINT [FK_PostJobTable_JobStatusTable];
GO
IF OBJECT_ID(N'[dbo].[FK_PostJobTable_UserTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PostJobTable] DROP CONSTRAINT [FK_PostJobTable_UserTable];
GO
IF OBJECT_ID(N'[dbo].[FK_UserTypeTable_UserTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserTable] DROP CONSTRAINT [FK_UserTypeTable_UserTable];
GO
...
IF OBJECT_ID(N'[dbo].[CompanyTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CompanyTable];
GO
IF OBJECT_ID(N'[dbo].[EmployeesTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EmployeesTable];
GO
IF OBJECT_ID(N'[dbo].[JobCategoryTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[JobCategoryTable];
GO
IF OBJECT_ID(N'[dbo].[JobNatureTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[JobNatureTable];
GO
IF OBJECT_ID(N'[dbo].[JobRequirementDetailsTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[JobRequirementDetailsTable];
GO
IF OBJECT_ID(N'[dbo].[JobRequirementsTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[JobRequirementsTable];
GO
IF OBJECT_ID(N'[dbo].[JobStatusTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[JobStatusTable];
GO
IF OBJECT_ID(N'[dbo].[PostJobTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[PostJobTable];
GO
IF OBJECT_ID(N'[dbo].[UserTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserTable];
GO
IF OBJECT_ID(N'[dbo].[UserTypeTable]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserTypeTable];
GO
...
ALTER TABLE [dbo].[EmployeesTables]
ADD CONSTRAINT [FK_EmployeesTable_UserTable]
    FOREIGN KEY ([UserId])
    REFERENCES [dbo].[UserTables]
        ([UserID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_EmployeesTable_UserTable'
CREATE INDEX [IX_FK_EmployeesTable_UserTable]
